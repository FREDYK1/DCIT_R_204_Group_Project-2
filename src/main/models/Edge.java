...
public class Edge {
    ...
    private int calculateTravelTime(double distance) {
        double walkingSpeed = 5.0; // km/h average walking speed
        double timeInHours = (distance / 1000.0) / walkingSpeed;
    ...
    public Edge getReverse() {
        return new Edge(destination, source, distance, weight, pathType);
    }
